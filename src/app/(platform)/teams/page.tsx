  ...
  return (
    <main style={{ padding: '24px 20px', maxWidth: '960px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
        <Link href="/teams" style={tabStyle(!recruiting)}>전체</Link>
        <Link href="/teams?recruiting=true"  style={tabStyle(recruiting === 'true')}>모집 중</Link>
        <Link href="/teams?recruiting=false" style={tabStyle(recruiting === 'false')}>모집 완료</Link>
      </div>
